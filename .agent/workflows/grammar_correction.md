...
1. **Find the latest test result file**
   - List the contents of `c:\Projects\ClaythornManor\Murder\game\tests\result`.
...
2. **Analyze for Grammar and Style**
   ...
   - Identify lines of dialogue or narration that violate the project's grammar/style rules (grammar-style.md)

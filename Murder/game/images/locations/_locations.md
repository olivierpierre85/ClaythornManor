...
| manor_on_fire          | grand 1920s two-storey Scottish manor seen from the gravel drive, the same house as `manor_exterior` but alight: flames rising from two chimneys and an upper window, black smoke drifting into the stormy sky, embers on the air, warm firelight on the stone facade, stormy daytime sky, luxurious garden and gravel drive in front       |
...
| forest_road            | proper country road of packed gravel and stone wide enough for a motor car, curving away through a dense Scottish forest, worn wheel ruts and a firm level surface with grassy verges on either side, tall trees crowding close, ferns and undergrowth beyond the verge, mist drifting between the trunks, grey afternoon light, touch of warm colors |
...
| forest_stream          | shallow rocky stream running through a dense Scottish forest, mossy boulders and ferns along the banks, mist between the tall trees, touch of warm colors                                                                    |
| bedroom_window_view    | view looking down from a high upstairs window of a 1920s Scottish manor, the garden far below with a gravel path and lawn, a low fence of black wrought-iron railings with sharp spikes standing on the ground along the path down in the garden, open air between the window and the ground, part of the stone facade at the side, touch of warm colors |

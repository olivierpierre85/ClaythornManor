...
label init_technical_variables:
    ...
    python:
        ...
        condition_saturday_hunt_morning = "(current_day == 'Saturday' and (current_phase == 'The Hunt' or current_phase == 'No Hunt') and current_hour<12)"
        ...
        condition_captain_host_suspicions = "(captain_details.threads.is_unlocked('captain_host_suspicion_name') and captain_details.threads.is_unlocked('captain_host_suspicion_portrait'))"
        ...
        image_checkpoint_four_sides ="images/ui/progress/rectangle_progress_four_sides.png"

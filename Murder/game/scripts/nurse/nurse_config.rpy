    ...
    python:
        ...
        nurse_objects = CharacterObjectList([
            ...
            CharacterInformation(
                ...
                relevant_chapters=['saturday_morning', 'saturday_afternoon', 'saturday_evening', 'sunday_afternoon'],
            ),
            CharacterInformation(
                0, "steal_pearls",
        ...
        nurse_endings = CharacterEndingList ([
            ...
            CharacterInformation(1, "psychic_fight_death", "You died confronting Mrs Baxter", image_file="fight_nurse_and_psychic", chapters=['sunday_afternoon']),

    ...
    # First define the possible progress
        nurse_progress = [
            ...
            [
                ...
                Chapter(image_ending_question, "ending", "escape_at_night", "sunday_morning"),
                Chapter(image_checkpoint_corner_half),
        ...
        nurse_test_checkpoints = {
            ...
            'saturday_afternoon': [
                ...
                {"label": "nurse_day2_hunt", "threads": {'take_gun': True}},
            ],
            'saturday_evening': [
                {"label": "nurse_day2_evening", "threads": {'day1_exhaustion': False}},
                {"label": "nurse_day2_evening", "threads": {'day1_exhaustion': True}},
                {"label": "nurse_day2_evening", "threads": {'remember_doctor': True}},
                {"label": "nurse_day2_evening", "threads": {'captain_lie_zanzibar': True}},
                {"label": "nurse_day2_evening", "threads": {'footman_actor': True, 'maid_actress': True}},
                {"label": "nurse_day2_evening", "threads": {'take_gun': True}},
                {"label": "nurse_day2_evening", "threads": {'take_gun': True, 'find_bullets': True}},
                ...
                {"label": "nurse_day2_evening", "threads": {'steal_pearls': True, 'steal_cutlery_1': True,  'steal_cutlery_2': True}},
                {"label": "nurse_day2_evening", "threads": {'captain_lie_zanzibar': True, 'captain_lie_boxer': True, 'footman_actor': True, 'maid_actress': True}},
                {"label": "nurse_day2_evening", "threads": {'day1_exhaustion': True, 'remember_doctor': True, 'captain_lie_zanzibar': True, 'captain_lie_boxer': True, 'spotted_by_psychic': True, 'footman_actor': True, 'maid_actress': True, 'steal_cutlery_1': True, 'steal_cutlery_2': True, 'take_gun': True, 'find_bullets': True}},
                {"label": "nurse_day2_evening", "threads": {'captain_lie_zanzibar': True, 'maid_actress': True, 'footman_actor': True, 'remember_doctor': True, 'take_gun': True, 'find_bullets': True}},
            ...
            'sunday_morning': [
                ...
                {"label": "nurse_day3_morning", "threads": { 'master_key': True,  'day1_exhaustion': True}},
            ],
            'sunday_afternoon': [

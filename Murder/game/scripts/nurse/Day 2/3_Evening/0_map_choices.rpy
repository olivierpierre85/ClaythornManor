label nurse_day2_evening_map_menu:
    python:
        ...
        nurse_day2_evening_map_menu = TimedMenu("nurse_day2_evening_map_menu", [
            ...
            TimedMenuChoice(default_room_text('gun_room'), 'nurse_day2_evening_gun_room', 10, room='gun_room', condition="not nurse_details.threads.is_unlocked('take_gun')", next_menu='nurse_gun_room_choice'),
            ...
            # first floor
            TimedMenuChoice(default_room_text('billiard_room'), 'nurse_day2_evening_billiard_room', 10, room='billiard_room', keep_alive=True, next_menu='nurse_day2_evening_billiard_room_menu'),
            ...
            TimedMenuChoice(default_room_text('bedroom_captain'), 'nurse_day2_evening_bedroom_captain', 10, room='bedroom_captain', next_menu='nurse_day2_evening_bedroom_captain'),
            TimedMenuChoice(default_room_text('bedroom_host'), 'nurse_day2_evening_bedroom_host', 10, room='bedroom_host', next_menu='nurse_day2_evening_bedroom_host'),

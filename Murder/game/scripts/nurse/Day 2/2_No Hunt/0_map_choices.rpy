label nurse_day2_no_hunt_map_menu:
    python:
        ...
        nurse_day2_no_hunt_map_menu = TimedMenu("nurse_day2_no_hunt_map_menu", [
            ...
            TimedMenuChoice(default_room_text('gun_room'), 'nurse_gun_room_default', 10, room='gun_room', condition="not nurse_details.threads.is_unlocked('take_gun')", next_menu='nurse_gun_room_choice'),
            ...
            # Bedrooms 
            TimedMenuChoice(default_room_text('bedroom_lad'), 'nurse_day2_no_hunt_bedroom_lad', 10, room='bedroom_lad', next_menu='nurse_day2_no_hunt_bedroom_lad'),
            TimedMenuChoice(default_room_text('bedroom_doctor'), 'nurse_day2_no_hunt_bedroom_doctor', 10, room='bedroom_doctor', next_menu='nurse_day2_no_hunt_bedroom_doctor'),
            TimedMenuChoice(default_room_text('bedroom_captain'), 'nurse_day2_no_hunt_bedroom_captain', 10, room='bedroom_captain', next_menu='nurse_day2_no_hunt_bedroom_captain'),
            TimedMenuChoice(default_room_text('bedroom_host'), 'nurse_day2_no_hunt_bedroom_host', 10, room='bedroom_host', next_menu='nurse_day2_no_hunt_bedroom_host'),
            ...
            # attic
            TimedMenuChoice(default_room_text('storage'), 'nurse_attic_storage', 10, room='storage', next_menu='nurse_attic_storage_search'),
            ...
            TimedMenuChoice(default_room_text('attic_butler_room'), 'nurse_attic_butler_room', 10, room='attic_butler_room', next_menu='nurse_attic_butler_cabinet_choice'),

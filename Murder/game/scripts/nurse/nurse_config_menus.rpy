label nurse_config_menu:
    ...
    $ drunk_generic_menu_nurse = TimedMenu("drunk_generic_menu_nurse", [
        ...
        TimedMenuChoice('Tell me more about yourself.', 'drunk_generic_background_nurse', 20, linked_choice ="drunk_generic_heroic_act_nurse"),
        ...
        TimedMenuChoice('How old are you?', 'drunk_generic_age_nurse', 20),
    ...
    $ host_generic_menu_nurse = TimedMenu("host_generic_menu_nurse", [
        ...
        TimedMenuChoice('How old are you?', 'host_generic_age_nurse', 10),

    ...
    python:
        ...
        broken_important_choices = CharacterImportantChoiceList([
            CharacterInformation(
                ...
                content_negative="You didn't drink the special whisky alone on the first night",
                image_file="whisky",
            ...
            CharacterInformation(
                0, "drunk_partner",
                "You partnered with Samuel Manning",
            ...
            CharacterInformation(
                0, "captain_convinced",
                "You won won Captain Sinha's trust",
                content_negative="You didn't win won Captain Sinha's trust",
                image_file="captain",
                chapters=['saturday_evening'],
            ...
            CharacterInformation(
                0, "gather_everyone",
                "You gathered everyone by ringing the dinner gong",
        ...
        broken_observations = CharacterObservationList([
            ...
            CharacterInformation(1, "drunk_letter",
                "You learned about a letter blaming Doctor Baldwin",
                content_negative="You didn't learn about a letter blaming Doctor Baldwin",
            ...
            CharacterInformation(1, "phone_dead",
                "You noticed the telephone is not working",
                content_negative="You didn't notice the telephone is not working",
                image_file="phone",
                chapters=['saturday_evening'],
                relevant_chapters=['saturday_evening', 'sunday_morning'],
            ),
            CharacterInformation(1, "staff_missing",
                "You realised the staff is gone",
                content_negative="You didn't realise the staff is gone",

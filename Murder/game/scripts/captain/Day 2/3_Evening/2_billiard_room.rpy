...
label captain_day2_evening_billiard_room:
    ...
    if not captain_details.saved_variables["day2_evening_billiard_room_visited"]:
        ...
        $ captain_day2_evening_billiard_room_menu = TimedMenu("captain_day2_evening_billiard_room_menu", [
            ...
            TimedMenuChoice('Wait and see who comes',
                'captain_day2_evening_billiard_room_host_with_suspicions', 0,
                condition="time_left<=20 and captain_details.threads.is_unlocked('captain_host_suspicion_name') and captain_details.threads.is_unlocked('captain_host_suspicion_portrait') and captain_details.threads.is_unlocked('captain_host_suspicion_shooting')"),
            TimedMenuChoice('Wait and see who comes',
                'captain_day2_evening_billiard_room_host_no_suspicions', 20,
                condition="time_left<=20 and not (captain_details.threads.is_unlocked('captain_host_suspicion_name') and captain_details.threads.is_unlocked('captain_host_suspicion_portrait') and captain_details.threads.is_unlocked('captain_host_suspicion_shooting'))"),

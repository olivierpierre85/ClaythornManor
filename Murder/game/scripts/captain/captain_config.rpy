label init_captain:
    ...
    python:
        ...
        captain_endings = CharacterEndingList ([
            ...
            CharacterInformation(8, "run_over",
                "You were run over on the road as you fled the manor alone on foot",
                image_file="run_over",
                chapters=['sunday_morning']),

...
label host_day1_evening:
    ...
    butler """
    Good, I have also written the speech you are to give at dinner.
    ...
    I have left a book out for you in the library.
    ...
    """
    I go up first, because I need the door shut and a moment to regroup.

    But not too long.

    I am expected downstairs, and failing to appear would raise questions.
    ...
    if not host_details.threads.is_unlocked('stayed_with_guests'):
        ...
        """
        I am exhausted, so I head back to my room for the night.
        """

    call host_day1_evening_debrief

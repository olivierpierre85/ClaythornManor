label lad_config_map:
    python:        
        ...
        lad_day1_evening_map_menu = TimedMenu([
            ...
            TimedMenuChoice(default_room_text('garden'), 'lad_day1_evening_garden', 10, room='garden'),
        ...
        lad_day2_no_hunt_map_menu = TimedMenu([
            ...
            TimedMenuChoice(default_room_text('garden'), 'lad_day2_no_hunt_garden', 30, room='garden'),

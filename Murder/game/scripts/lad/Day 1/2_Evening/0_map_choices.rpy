...
label lad_day1_evening_map_menu:
    python:    
        lad_day1_evening_map_menu = TimedMenu(
            ...
            TimedMenuChoice(default_room_text('attic_butler_room'), 'lad_day1_evening_butler_room', 10, room='attic_butler_room'),
...
label lad_day1_evening_servant_stairs:
    ...
    call lad_servant_stairs_default("lad_day1_evening_servant_stairs_menu")

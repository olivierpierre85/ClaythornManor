label lad_config_menu:
    ...
    $ psychic_generic_menu_lad = TimedMenu("psychic_generic_menu_lad", [
        ...
        TimedMenuChoice('Which guests do you think could be dangerous?', 'psychic_generic_other_guests_saturday_evening', 0, keep_alive = True, condition = condition_saturday_evening, next_menu="psychic_generic_other_guests_menu_lad"),
    ...
    $ doctor_generic_menu_lad = TimedMenu("doctor_generic_menu_lad", [
        ...
        TimedMenuChoice('Why were you invited here?', 'doctor_generic_heroic_act', 30, condition = "is_linked_choice_hidden('doctor_generic_menu_lad', 'doctor_generic_heroic_act')"),
        ...
        TimedMenuChoice('What do you think of the other guests?', 'doctor_generic_other_guests_friday', 0, condition = "current_day == 'Friday'", next_menu="doctor_generic_other_guests_menu_lad"),
        TimedMenuChoice('What do you think of the other guests?', 'doctor_generic_other_guests_saturday', 0, condition = "current_day == 'Saturday'", next_menu="doctor_generic_other_guests_menu_lad"),

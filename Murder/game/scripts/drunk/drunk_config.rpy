label init_drunk:
    ...
    python:
        ...
        drunk_extra_information = CharacterDescriptionHiddenList([
            ...
            CharacterInformation(70, "faked_death", "he can play dead as well as drunk. He lay a whole day in his bed at Claythorn Manor with his throat painted in port, and nobody came close enough to look twice", is_important = True, unlock_chapters=[('host', 'sunday_afternoon'), ('drunk', 'sunday_morning')]), # He tells the Host himself, in the dining room, once he has woken her

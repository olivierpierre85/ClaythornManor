label init_doctor:
    ...
    python:
        ...
        doctor_important_choices = CharacterImportantChoiceList([
            ...
            CharacterInformation(
                0, "trust_captain",
                "You slept in Captain Sinha's room",
                content_negative="You didn't sleep in Captain Sinha's room",
            ...
            CharacterInformation(
                0, "trust_nurse",
                "You slept in Rosalind Marsh's room",
                content_negative="You didn't sleep in Rosalind Marsh's room",
                image_file="trust_nurse",
                chapters=['saturday_evening'],
                relevant_chapters=['saturday_evening', 'sunday_morning', 'sunday_afternoon'],
            ),
            # CharacterInformation(
        ...
        doctor_endings = CharacterEndingList ([
            ...
            CharacterInformation(5, "shot", "You were shot in the face", image_file="gun_firing", chapters=['end']), 
        ...
        doctor_extra_information = CharacterDescriptionHiddenList ([
            ...
            CharacterInformation(3, "addict", "sometimes fidgets for no apparent reason. This is common among opioid addicts", is_important = True, unlock_chapters=[('lad', 'saturday_evening'), ('drunk', 'saturday_afternoon')]),
            CharacterInformation(3, "fraud", "an affliction that led him to stealing drugs from his patients", is_important = True, unlock_chapters=[('lad', 'saturday_afternoon'), ('drunk', 'friday_evening')]),

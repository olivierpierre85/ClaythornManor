label init_doctor:
    ...
    python:
        ...
        doctor_extra_information = CharacterDescriptionHiddenList ([
            CharacterInformation(0, "background", "a charity hospital", is_important = True), 
        ...
        # Glasses on his nose, this 39-year-old doctor has spent the last decade working for a charity hospital.

label psychic_config_menu:
    ...
    $ nurse_generic_menu_psychic = TimedMenu("nurse_generic_menu_psychic", [
        ...
        TimedMenuChoice('Why were you invited here?', 'nurse_generic_heroic_act_psychic', 20, condition = "is_linked_choice_hidden('nurse_generic_menu_psychic', 'nurse_generic_heroic_act_psychic')"),
    ...
    $ doctor_generic_menu_psychic = TimedMenu("doctor_generic_menu_psychic", [
        ...
        TimedMenuChoice('Why were you invited here?', 'doctor_generic_heroic_act', 20, condition = "is_linked_choice_hidden('doctor_generic_menu_psychic', 'doctor_generic_heroic_act')"),
    ...
    $ captain_generic_menu_psychic = TimedMenu("captain_generic_menu_psychic", [
        TimedMenuChoice('Tell me more about yourself', 'captain_generic_background_psychic', 30, linked_choice="captain_generic_heroic_act_psychic"),
        ...
        TimedMenuChoice('Why were you invited here?', 'captain_generic_heroic_act_psychic', 30, condition = "is_linked_choice_hidden('captain_generic_menu_psychic', 'captain_generic_heroic_act_psychic')"),
        ...
        TimedMenuChoice('There is something weird about Rosalind Marsh{{observation}}', 'psychic_day2_evening_nurse_captain', 30, condition = condition_saturday + " and psychic_details.threads.is_unlocked('silverware')"),
        # exit
    ...
    $ lad_generic_menu_psychic = TimedMenu("lad_generic_menu_psychic", [
        ...
        TimedMenuChoice('Why were you invited here?', 'lad_generic_heroic_act_psychic', 40, condition = "is_linked_choice_hidden('lad_generic_menu_psychic', 'lad_generic_heroic_act_psychic')"),

label init_psychic:
    ...
    python:
        ...
        psychic_extra_information = CharacterDescriptionHiddenList([
            ...
            CharacterInformation(4, "lie", "deathbed, she confessed to being a fraud, admitting she is nothing but an con artist", is_important = True, unlock_chapters=[('lad', 'sunday_afternoon')]),
            CharacterInformation(5, "drive", "cannot drive", unlock_chapters=[('lad', 'sunday_morning')]),

...
Some menus have inherited / mis-named ids: the dinner menu id is `doctor_day1_evening` and the nurse-bedroom sleep menu id is `broken_generic_other_guests_friday_offense`. The plan files reference those ids verbatim.

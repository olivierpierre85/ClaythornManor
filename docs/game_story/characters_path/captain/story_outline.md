# 🕵️ Captain's Story Outline: Sushil Sinha

## 💂 Perspective & Tone
The Captain is a formal, meticulous, and highly observant Indian officer. He has spent his life mastering British manners to "earn" a place in society, only to find the doors still closed. He views the manor guests with an analytical eye, quickly spotting those who, like himself, are "pretenders" or out of place.

- **Primary Goal**: Expose the Host, Lady Claythorn, as an impostor and survive the manor's hidden dangers.
- **Key Trait**: Observant. He notices inconsistencies in etiquette, genealogy, and military history that others miss.
...
- **Library Investigation**: 
    - Finds the genealogy book open on the table.
    - **Discovery**: "Claythorn" is the name of the manor/region, but the Host should have a proper family surname (e.g., Lady Grantham of Claythorn). Her use of "Lady Claythorn" as a full name is a social blunder. It Unlocks the "Host suspicion" thread.
- **Outside (Rain)**: A unique map option for the Captain. He can venture out where others won't, but he must return to change his clothes (losing time) unless he has the right gear.
- **bedrooms, attic, downstairs**: On the first day, he is not suspicious enough to dare venture where is clearly not allowed. He time a choice like this is made, he won't change room and say something like "I can't go there, it's not what a proper gentleman do". Add list of different ways of saying that, and block entire downstair after one try, attic also after one try, and after two bedrooms, all the bedrooms but his own.
...
### ☀️ Day 3: Sunday
**The Escape**
- **Intuition System**: He can't get out without which ENDING? Kill by host? Or killed while leaving WITHOUT a car. His intuition if HE knows host is suspicious but didn't confront her, AND he died trying to escape without a car. The intuition will kick in and help him get out with the car, the psychic and the lad?
- **The Choice**: 
    - Use the **Oil** to fix the car and escape with the Lad and Psychic? 
    - Or take charge and try to save the remaining guests?
- **Ending**: If he exposes the Host early, it may lead to her being cornered by those she deceived.

---

## 🛠️ Game Mechanics & Threads
...
### 🧵 Major Threads
- `host_is_impostor`: Central mystery for the Captain.
- `captain_observation_dinner`: Tracks specific clues found during Friday's meal.


### 🗺️ Map Access
- **Outside (Rain)**: A unique map option for the Captain. He can venture out where others won't, but he must return to change his clothes (losing time) unless he has the right gear.
- **Shed**: Accessed via the Garden map using the Master Key.
